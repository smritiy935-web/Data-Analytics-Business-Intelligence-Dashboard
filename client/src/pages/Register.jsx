      ...
      >
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Join InsightFlow</h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm">Start analyzing your business data today.</p>
          </div>
          ...
          <p className="text-center mt-8 text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link to="/login" className="text-primary-600 hover:text-primary-700 font-semibold underline underline-offset-4">
              Log in
            </Link>
          </p>
        </div>
