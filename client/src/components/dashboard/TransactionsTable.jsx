      ...
      <table className="w-full text-sm text-left">
        <thead>
          <tr className="border-b border-slate-100 dark:border-slate-800">
            <th className="py-2.5 px-3 text-slate-500 font-medium">ID</th>
            <th className="py-2.5 px-3 text-slate-500 font-medium">Customer</th>
            <th className="py-2.5 px-3 text-right text-slate-500 font-medium">
              Amount
            </th>
            <th className="py-2.5 px-3 text-center text-slate-500 font-medium">
              Status
            </th>
            <th className="py-2.5 px-3 text-right text-slate-500 font-medium">
              Date
        ...
        <tbody>
          {recentTransactions.map((tx) => (
            ...
            >
              <td className="py-2.5 px-3 font-mono text-xs">{tx.id}</td>
